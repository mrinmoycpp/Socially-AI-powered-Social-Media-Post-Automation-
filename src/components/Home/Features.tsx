            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    <div className="mb-6 inline-flex items-center gap-1.5 bg-blue-500/10 border border-blue-500/15 text-blue-500 text-[11px] font-medium tracking-[0.06em] uppercase px-3.5 py-1.5 rounded-full">
                        ...
                        Everything you need to schedule your social media
                    </div>
                    <h2 className="font-serif text-4xl sm:text-5xl font-medium leading-tight text-gray-900">
                        Automate your entire content <span className="text-blue-400 font-semibold">pipeline</span>
                        <br />
                        <span className="text-black-400 italic">social media <span className="text-blue-400">workflow</span></span>
                    </h2>
                    <p className="mt-5 text-gray-500 max-w-xl mx-auto leading-relaxed">Create, organize, and schedule with ease — Scheduler handles the heavy lifting for your social media </p>
                </div>
