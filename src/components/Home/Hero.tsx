    ...
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 text-blue-500 text-sm px-3.5 py-1.5 rounded-full mb-8">
                    <span className="size-1.5 bg-blue-600 rounded-full" />
                    AI-Powered Social Media Automation
                </div>

                {/* Headline */}
                <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-slate-900 fontsize-9xl leading-[1.05]">
                   <span>Schedule your Social</span>.
                    <br />
                    <span className="text-blue-500 italic">Grow <span className="font-bold">faster</span>.</span>
                </h1>

                {/* Subheadline */}
                <p className="mt-7 text-gray-500 max-w-2xl mx-auto">Create, schedule, and publish content effortlessly across every social platform with AI-powered automation built for creators and <span className="font-bold">brands</span>.</p>

                {/* CTAs */}
                <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
                    <Link to="/login" className="bg-blue-500 text-white rounded-full font-medium hover:bg-blue-600 hover:shadow-[0_8px_24px_rgba(239,68,68,0.35)] inline-flex items-center gap-2 text-[15px] px-8 py-3.5 w-full sm:w-auto justify-center transition-all">
                        Schedule it for free<ArrowRightIcon className="size-4" />
                    </Link>
                        ...
                        <div className="rounded-xl p-4 space-y-3 bg-white" style={{ border: "1px solid rgba(0,0,0,0.06)" }}>
                            ...
                            {[
                                ...
                                <div key={item.text} className="flex items-center gap-3">
                                    <DotIcon className="size-5 text-blue-300" />
